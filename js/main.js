const vaiMudar = false, cont, valor, historico = Array(), memoria = Array(), fe = false, hyp = false, deg = "deg";
...
function atualiza() {
    ...
    setTimeout(function(){
        ...
        $('.numeros').css('background-color', 'rgba(250, 250, 250)');
    }, 100);
    $('.col').hover(function(){
        $('.col').css('background-color', 'rgb(216, 216, 216)');
    }, function(){
...
$(document).on('click', '.opp', function(){
    ...
    $(document).on('click', '#elevado', function(){
        atualiza();
        $('valor').html($('#valor2').text() + $('#valor').text() + " ^ ");
        vaiMudar = true;
    });
    ...
    $(document).on('click', '#dezax', function(){
        atualiza();
        log = Math.pow(10, parseFloat(valor))
    ...
    $(document).on('click', '#ln', function(){
        atualiza();
        ln = Math.pow(parseFloat(valor))/Math.log(2.71828182845904523);
